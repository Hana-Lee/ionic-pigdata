...
(function () {
  ...
  var paths = {
    ...
    scripts: ['./app/js/**/{!(app.js), !(index.js), *.js}', './app/js/app.js'],
  ...
  function _minifyTemplates(path, destPath) {
  ...
  gulp.task('templates', ['clean-templates'], function () {
    return _minifyTemplates(paths.templates).on('end', function () {
      gulp.src('').pipe(notify({message : 'Templates builded'}));
    });
  });

  function _minifyImages(path, destPath) {
    return gulp.src(path)
  ...
  gulp.task('images', ['clean-images'], function () {
    return _minifyImages(paths.images).on('end', function () {
  ...
  gulp.task('watch', function () {
    ...
    gulp.watch(paths.templates, function (event) {
      ...
      if (event.type === 'deleted') {
        ...
        _minifyTemplates(pathFile, destPath).on('end', function () {
    ...
    gulp.watch(paths.images, function (event) {
      ...
      if (event.type === 'deleted') {
        ...
        var pathFile = path.relative(__dirname, event.path);
        var destPath = path.dirname(destPathFile);
        _minifyImages(pathFile, destPath).on('end', function () {
